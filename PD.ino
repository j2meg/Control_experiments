...
volatile int Out   = 0; // MCP4725 16 bits DAC  vañues(0,4095)
volatile float ek=0,ek1 = 0;

volatile float Uk=0; // Esfuerzo de control 
volatile float Uk1=0; // Esfuerzo de control 
